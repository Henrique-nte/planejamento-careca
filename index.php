...
<head>
    ...
    <style>
        ...
        .colorBlock {
            position: absolute;
            top: -100px; /* Adjusted from -200px to -100px */
            width: 100%;
            height: 30%;
        ...
        .container {
            position: relative;
            top: -200px; /* Adjusted from -300px to -200px */
            left: 20px;
            text-align: left;
            width: 100%;
            padding-left: 10px;
        ...
        .hamburger {
            ...
            height: 22px;
            position: relative;
            top: -440px; /* Adjusted from -440px to -340px */
            left: 20px;
        }
        .hamburger div {
            width: 100%;
        ...
        button {
            ...
            align-self: center;
            position:relative;
            transform: translate(-1400%, 30%);
            top: 10px;
            left: -60px;
            border-radius: 10px; /* Adicione esta linha para bordas arredondadas */
        ...
        button:hover {
            ...
            background-color: #55e273; /* Adicione esta linha para um fundo verde escuro ao passar o mouse */
        }
...
<body>
    ...
    <div class="container">
        ...
        <div class="borderContainer">
            <div class="brand">
            <div class="title"><h3><span>Gastos</span></h3> </div>
